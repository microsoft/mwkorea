...
tags:
  ...
  - Skill
  - 월간코파일럿
excerpt: 'Copilot Cowork가 재무 업무를 바꾸는 방법 — Microsoft Enterprise Commercial Finance 정경화(Jamie)님이 전하는 보고서 자동화, 데이터 검증, 그리고 스킬로 업무 지식을 자산화하는 이야기.'
header:
...
<div class="mc-issue-strip">Monthly Copilot · September 2026 · 월간 코파일럿 9월호 · 人(인)터뷰</div>
...
<div class="mc-card mc-card--teal">
  ...
  <div>Microsoft Enterprise Commercial Finance <strong>정경화(Jamie)</strong></div>
</div>

<p>기업의 업무는 점점 더 복잡해지고 있다. 데이터는 늘어나고, 보고서는 많아지며, 이해관계자들의 요구는 더욱 다양해지고 있다. 특히 재무 조직은 수많은 데이터를 분석하고, 정확성을 검증하며, 경영진과 현업 부서에 필요한 인사이트를 제공해야 한다.</p>
...
<p>Jamie는 현재 재무 조직에서 다양한 보고 업무를 수행하고 있다. 특히 Copilot Cowork를 활용해 <strong>매주 진행되는 파이프라인 리뷰 업무</strong>를 자동화하고 있다. 대표적인 활용 방식은 다음과 같다.</p>

<div class="mc-card-grid">
  <div class="mc-card mc-card--teal">
    <div class="mc-card-title"><strong>주간 파이프라인 변화 분석</strong></div>
    <div>지난주 대비 변화를 자동으로 비교·요약</div>
  </div>
  <div class="mc-card mc-card--teal">
    <div class="mc-card-title"><strong>이해관계자별 맞춤 보고서</strong></div>
    <div>리더별 관심 지표에 맞춘 개인화된 보고서 생성</div>
  </div>
  <div class="mc-card mc-card--teal">
    <div class="mc-card-title"><strong>데이터 검증 및 리스크 탐지</strong></div>
    <div>데이터 소스 간 교차 검증과 이상 항목 표시</div>
  </div>
  <div class="mc-card mc-card--teal">
    <div class="mc-card-title"><strong>이메일 보고서 초안 작성</strong></div>
    <div>전달까지 이어지는 커뮤니케이션 초안 자동 생성</div>
  </div>
</div>
...
<h2 class="mc-section-title">🚀 Cowork가 만드는 새로운 업무 방식</h2>

<p>많은 사람들이 AI를 "질문에 답하는 도구" 정도로 생각한다. 하지만 Jamie가 경험한 Copilot Cowork는 조금 달랐다. 단순히 질문에 답하는 것이 아니라 <strong>실제 업무 프로세스를 수행</strong>한다.</p>

<div class="mc-card-grid">
  <div class="mc-card mc-card--red">
    <div class="mc-card-title"><strong>기존 방식</strong></div>
    <div>① 여러 시스템에서 데이터 추출<br/>② Excel 정리<br/>③ 변화된 내용 수작업 비교<br/>④ 보고서 작성<br/>⑤ 이메일 작성<br/>⑥ 전달 및 검토</div>
  </div>
  <div class="mc-card mc-card--green">
    <div class="mc-card-title"><strong>Copilot Cowork</strong></div>
    <div>① 데이터 수집<br/>② 변화 분석<br/>③ 주요 이슈 탐지<br/>④ 맞춤형 보고서 생성<br/>⑤ 이메일 초안 작성<br/><strong>➜ 담당자는 최종 검토와 판단에 집중</strong></div>
  </div>
</div>
...
<h2 class="mc-section-title">🛡️ 재무 조직은 정확성이 중요한데 괜찮을까?</h2>

<p>재무 업무에서 AI 활용 시 가장 많이 나오는 질문은 <strong>정확성</strong>이다. Jamie 역시 처음에는 같은 고민을 했다. 이를 해결하기 위해 Cowork 업무 프로세스 안에 <strong>검증 절차</strong>를 포함시켰다.</p>

<div class="mc-card-grid mc-card-grid--3">
  <div class="mc-card mc-card--amber">
    <div class="mc-card-title"><strong>소스 비교</strong></div>
    <div>서로 다른 데이터 소스를 교차 비교</div>
  </div>
  <div class="mc-card mc-card--amber">
    <div class="mc-card-title"><strong>허용 범위 경고</strong></div>
    <div>기준을 초과하면 경고를 표시</div>
  </div>
  <div class="mc-card mc-card--amber">
    <div class="mc-card-title"><strong>작업 중단</strong></div>
    <div>특정 수준 이상의 차이 발생 시 생성 중단</div>
  </div>
  <div class="mc-card mc-card--amber">
    <div class="mc-card-title"><strong>리스크 표시</strong></div>
    <div>리스크 항목을 별도 섹션으로 분리</div>
  </div>
  <div class="mc-card mc-card--amber">
    <div class="mc-card-title"><strong>최종 검토 후 발송</strong></div>
    <div>사람이 확인한 뒤에 전달</div>
  </div>
</div>
...
<h2 class="mc-section-title">🧠 Cowork를 더 똑똑하게 만드는 방법 — 스킬(Skill)</h2>
...
<div class="mc-card-grid mc-card-grid--3">
  <div class="mc-card mc-card--purple">
    <div class="mc-card-title"><strong>보고서 작성 기준</strong></div>
    <div>어떤 형식으로, 무엇을 담을지</div>
  </div>
  <div class="mc-card mc-card--purple">
    <div class="mc-card-title"><strong>데이터 검증 기준</strong></div>
    <div>어디까지 허용하고 언제 멈출지</div>
  </div>
  <div class="mc-card mc-card--purple">
    <div class="mc-card-title"><strong>예외 처리 방식</strong></div>
    <div>규칙 밖의 상황을 다루는 법</div>
  </div>
  <div class="mc-card mc-card--purple">
    <div class="mc-card-title"><strong>조직 특화 지식</strong></div>
    <div>우리 조직에서만 통하는 맥락</div>
  </div>
  <div class="mc-card mc-card--purple">
    <div class="mc-card-title"><strong>업무 노하우</strong></div>
    <div>경험으로 쌓인 판단 기준</div>
  </div>
</div>
...
<div class="mc-card mc-card--blue">
  <div class="mc-card-title"><strong>① Copilot Cowork 보고서 자동화 프롬프트</strong></div>
  <div>이번 주 데이터와 지난주 데이터를 비교해줘.<br/>
  주요 변화 사항을 요약해줘.<br/>
  신규 추가된 항목을 알려줘.<br/>
  삭제된 항목을 알려줘.<br/>
  리스크 가능성이 있는 항목을 표시해줘.<br/>
  결과는 임원용 주간 보고서 형식으로 작성해줘.<br/>
  최종 결과에 주요 인사이트를 포함해줘.</div>
</div>

<div class="mc-card mc-card--blue">
  <div class="mc-card-title"><strong>② Cowork 검증 프로세스 추가 프롬프트</strong></div>
  <div>보고서를 작성하기 전에 다음 검증을 수행해줘.<br/>
  데이터 소스 간 값 차이를 비교해줘.<br/>
  차이가 기준값 이상이면 보고서 생성을 중단해줘.<br/>
  차이 원인을 설명해줘.<br/>
  검증 결과를 별도 섹션으로 정리해줘.</div>
</div>

<div class="mc-card mc-card--blue">
  <div class="mc-card-title"><strong>③ Skill 업데이트 프롬프트</strong></div>
  <div>지금까지 전달한 내용을 업무 스킬로 저장해줘.<br/>
  업무 목적 / 사용 데이터 / 검증 규칙 / 예외 처리 방식 / 보고서 형식<br/>
  기존 스킬과 충돌하는 내용이 있으면 먼저 알려주고 이후 반영해줘.</div>
</div>
...
<p>이번 인터뷰를 통해 확인할 수 있었던 메시지는 명확하다. 👉 <strong>Copilot Cowork의 핵심 가치는 "업무 실행"이다.</strong> 단순히 질문에 답하는 AI가 아니다. 특히 다음 네 가지 영역에서 강력한 가치를 제공한다.</p>

<div class="mc-card-grid mc-card-grid--4">
  <div class="mc-card mc-card--green">
    <div class="mc-card-title"><strong>반복 업무 자동화</strong></div>
  </div>
  <div class="mc-card mc-card--green">
    <div class="mc-card-title"><strong>이해관계자별 개인화</strong></div>
  </div>
  <div class="mc-card mc-card--green">
    <div class="mc-card-title"><strong>검증 프로세스 내재화</strong></div>
  </div>
  <div class="mc-card mc-card--green">
    <div class="mc-card-title"><strong>업무 지식 자산화</strong></div>
  </div>
</div>
