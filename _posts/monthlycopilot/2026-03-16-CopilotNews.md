...
excerpt: "Word, Excel, PowerPoint에서 Copilot이 직접 편집하고 이어서 일하는 Agent Mode를 정리했습니다. Chat 기반 Agents와의 차이, 대표 활용 장면, 바로 써볼 수 있는 실전 프롬프트 9개까지 담았습니다."
header:
...
<div class="mc-cover">
  ...
  <div class="mc-cover-title">이제 Copilot은 ‘도구’가 아니라 ‘동료’입니다</div>
...
<div style="margin: 0 0 1.3rem; padding: 1rem 1.1rem; border-radius: 16px; background: linear-gradient(135deg, #eff6ff 0%, #f8fafc 100%); border: 1px solid #bfdbfe; color: #1f2937;">
  ...
  <div style="line-height: 1.8;">이번 달 월간 코파일럿에서는 Microsoft 365 Copilot의 새로운 진화, Agent Mode를 소개합니다. 이제 Copilot은 단순히 “물어보면 답해주는 AI”를 넘어, 문서·데이터·슬라이드 안에서 함께 일하는 협업 파트너로 진화하고 있습니다.</div>
</div>
...
<img src="/mwkorea/assets/images/20260316-copilot-news/copilot-news-image1.png" alt="Agent Mode 소개 대표 이미지" />

<hr/>

<h2 style="margin-top: 1.4rem; padding: 0.55rem 0.85rem; border-left: 6px solid #2563eb; background: #f8fafc;">✨ Agent Mode란 무엇인가요?</h2>

<p>Agent Mode는 Word, Excel, PowerPoint 앱 안에서 Copilot이 실제 문서(Canvas) 위에서 여러 단계를 스스로 계획하고 실행하며 사람과 협업하듯 작업을 이어가는 새로운 작업 방식입니다.</p>
...
<div style="display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); gap: 14px; margin: 1rem 0 1.4rem;">
  <div style="padding: 1rem 1.05rem; border-radius: 14px; background: #eff6ff; border: 1px solid #bfdbfe; color: #1e3a8a;">
    <div style="font-weight: 800; margin-bottom: 0.35rem;">실제 문서(Canvas) 위에서</div>
    <div>Word, Excel, PowerPoint 앱 안에서 결과물을 바로 다룹니다.</div>
  </div>
  <div style="padding: 1rem 1.05rem; border-radius: 14px; background: #ecfeff; border: 1px solid #99f6e4; color: #115e59;">
    <div style="font-weight: 800; margin-bottom: 0.35rem;">여러 단계를 스스로 계획하고 실행</div>
    <div>계획, 편집, 반복 작업을 한 흐름으로 이어갑니다.</div>
  </div>
  <div style="padding: 1rem 1.05rem; border-radius: 14px; background: #eef2ff; border: 1px solid #c7d2fe; color: #3730a3;">
    <div style="font-weight: 800; margin-bottom: 0.35rem;">사람과 협업하듯 이어가는 방식</div>
    <div>단순 응답이 아니라 함께 완성해 가는 협업형 작업입니다.</div>
  </div>
</div>
...
<img src="/mwkorea/assets/images/20260316-copilot-news/copilot-news-image2.png" alt="Agent Mode in Word 섹션 이미지" />
...
<div style="margin: 1rem 0 1.4rem; padding: 1rem 1.1rem; border-radius: 16px; background: #f8fafc; border: 1px solid #dbe4f0; color: #111827;">
  ...
  <div style="line-height: 1.85;">“이 문서를 이번 달 버전으로 업데이트해줘.<br/>/9월 데이터 메일을 반영하고,<br/>지난달 대비 달라진 포인트를 요약해줘.”</div>
  ...
  <div style="margin-top: 0.55rem; color: #64748b;">변경 포인트를 한눈에 보이게 정리합니다. [Agent Mode...Use Cases | PowerPoint]</div>
  <div style="margin-top: 0.6rem; color: #64748b;">[Agent Mode...Use Cases | PowerPoint]</div>
  <div style="margin-top: 0.7rem; color: #334155;">✅ 문서를 새로 만들 필요 없이 · ✅ 검토 가능한 상태로 · ✅ 사람이 한 것처럼 자연스럽게</div>
</div>

<img src="/mwkorea/assets/images/20260316-copilot-news/copilot-news-image3.png" alt="Agent Mode in Excel 섹션 이미지" />
...
<div style="margin: 1rem 0 1.4rem; padding: 1rem 1.1rem; border-radius: 16px; background: #f8fafc; border: 1px solid #dbe4f0; color: #111827;">
  ...
  <div style="margin-top: 0.5rem; color: #64748b;">👉 숫자 → 스토리 → 의사결정까지 한 번에 [Agent Mode...Use Cases | PowerPoint]</div>
  <div style="margin-top: 0.5rem; color: #475569;">원문 포함 자료: AgentMode_Excel.mp4</div>
</div>

<img src="/mwkorea/assets/images/20260316-copilot-news/copilot-news-image4.png" alt="Agent Mode in PowerPoint 섹션 이미지" />
...
<img src="/mwkorea/assets/images/20260316-copilot-news/copilot-news-image5.png" alt="Agent Mode 핵심 요약 이미지" />

<hr/>

<h2 style="margin-top: 1.4rem; padding: 0.55rem 0.85rem; border-left: 6px solid #ea580c; background: #f8fafc;">🔍 Agent Mode, 이렇게 기억하세요</h2>

<div style="display: grid; grid-template-columns: 1fr; gap: 14px; margin: 1rem 0 1.4rem;">
  <div style="padding: 1rem 1.1rem; border-radius: 14px; background: #eff6ff; border: 1px solid #bfdbfe; color: #1d4ed8;">✅ 앱 안에서 바로 일하는 Copilot</div>
...
<div style="margin: 1rem 0 1.4rem; padding: 1rem 1.1rem; border-radius: 16px; background: #111827; color: #f9fafb;">
  🧭 Agent Mode는 “AI가 일을 대신해주는 기능”이 아니라 “AI와 함께 일하는 방식의 변화”입니다.
</div>
...
<div style="margin: 0 0 1.4rem; padding: 1rem 1.1rem; border-radius: 16px; background: #eef2ff; border: 1px solid #c7d2fe; color: #3730a3;">
  ...
  Agent Mode의 핵심은 더 똑똑한 답변이 아니라, 앱 안에서 사람과 같은 흐름으로 같이 수정하고 완성해 간다는 점입니다.
</div>

<img src="/mwkorea/assets/images/20260316-copilot-news/copilot-news-image6.png" alt="Word 실전 프롬프트 시작 이미지" />

<hr/>

<h2 style="margin-top: 1.4rem; padding: 0.55rem 0.85rem; border-left: 6px solid #2563eb; background: #f8fafc;">🙋‍♀️ 여러분도 체험해보세요: Agent Mode 실전 프롬프트 모음</h2>
...
<img src="/mwkorea/assets/images/20260316-copilot-news/copilot-news-image7.png" alt="Word 프롬프트 2 이미지" />
...
<img src="/mwkorea/assets/images/20260316-copilot-news/copilot-news-image8.png" alt="Word 프롬프트 3 이미지" />
...
<img src="/mwkorea/assets/images/20260316-copilot-news/copilot-news-image9.png" alt="Excel 실전 프롬프트 시작 이미지" />
...
<img src="/mwkorea/assets/images/20260316-copilot-news/copilot-news-image10.png" alt="Excel 프롬프트 5 이미지" />
...
<img src="/mwkorea/assets/images/20260316-copilot-news/copilot-news-image11.png" alt="Excel 프롬프트 6 이미지" />
...
<img src="/mwkorea/assets/images/20260316-copilot-news/copilot-news-image12.png" alt="PowerPoint 실전 프롬프트 시작 이미지" />
...
<img src="/mwkorea/assets/images/20260316-copilot-news/copilot-news-image13.png" alt="PowerPoint 프롬프트 8 이미지" />
...
<img src="/mwkorea/assets/images/20260316-copilot-news/copilot-news-image14.png" alt="PowerPoint 프롬프트 9 이미지" />
...
<img src="/mwkorea/assets/images/20260316-copilot-news/copilot-news-image15.png" alt="Agent Mode 활용 팁 이미지" />
