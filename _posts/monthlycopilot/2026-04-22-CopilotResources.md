...
<div class="mc-issue-strip">Monthly Copilot · May 2026 · 월간 코파일럿 5월호 · Learning Roadmap</div>

<div class="mc-cover">
  <div class="mc-cover-kicker">🤖 월간 코파일럿 · May 2026</div>
  <div class="mc-cover-title">AI 시대, 나만 구경꾼이었다</div>
  <div class="mc-cover-subtitle">내 페이스대로 M365 Copilot 마스터하는 완벽 학습 로드맵</div>
</div>
...
<div style="margin: 0 0 1.3rem; padding: 1rem 1.1rem; border-radius: 16px; background: linear-gradient(135deg, #eff6ff 0%, #f8fafc 100%); border: 1px solid #bfdbfe; color: #1f2937;">
  <div style="font-weight: 800; color: #1d4ed8; margin-bottom: 0.35rem;">지금 당신의 Copilot 지식, 몇 레벨이세요?</div>
...
<div style="margin: 1rem 0 1.4rem; padding: 1rem 1.1rem; border-radius: 16px; background: #f8fafc; border: 1px solid #dbe4f0; color: #111827;">
  <div style="font-weight: 800; margin-bottom: 0.45rem; color: #0f766e;">들어가며</div>
  <div style="line-height: 1.85; color: #374151;">
    <p>모두가 AI를 외칠 때, 정작 나는 어디서부터 시작해야 할까? "AI 하세요?"는 어느새 인사말이 됐다. 솔직히 말하면, '어디서부터 시작하지?'라는 막막함이 먼저 드는 게 훨씬 더 인간적인 반응이다.</p>
    <p>Microsoft 365 Copilot이 다른 이유는 여기에 있다. 새로운 앱을 배울 필요가 없다. Word를 열면 거기 있고, Teams 회의 중에도, Outlook 받은 편지함에서도 같은 자리에 있다.</p>
    <p>Copilot을 한두 번 써보고 "별로네"라고 느끼셨다면, 그 느낌 충분히 이해한다. 그런데 혹시, 처음 배웠던 방식 그대로 멈춰 있었던 건 아닐까? Copilot은 지난 1년 사이 완전히 다른 제품이 됐다. 지금부터 레벨별로 제대로 짚어보자.</p>
  </div>
</div>

<hr/>

<h2 style="margin-top: 1.4rem; padding: 0.55rem 0.85rem; border-left: 6px solid #22c55e; background: #f8fafc;">🟢 초급 — 일단 맛은 봐야지</h2>

<p>AI가 담지 뭔가 하는데 Copilot이 내 업무에 어떻게 쓰이는지 감이 안 잡힌다면? 겁먹지 마시라. 아래 무료 강좌들은 '코파일럿이 뭐야?'에서 '오, 이거 쓸 만한데!'로 넘어가게 해준다.</p>
...
<h2 style="margin-top: 1.4rem; padding: 0.55rem 0.85rem; border-left: 6px solid #eab308; background: #f8fafc;">🟡 중급 — 이제 좀 써먹어 볼까?</h2>

<p>Copilot 기본은 익혔는데 '에이전트'라는 단어가 등장하기 시작했다. 두렵다면? 이 강의들이 "에이전트는 개발자 몫"이라는 고정관념을 박살내줄 것이다.</p>
...
<h2 style="margin-top: 1.4rem; padding: 0.55rem 0.85rem; border-left: 6px solid #ef4444; background: #f8fafc;">🔴 고급 — 이제 내가 직접 만들어 볼게</h2>

<p>Copilot을 '쓰는 사람'에서 '만드는 사람'으로 레벨업할 시간. Copilot Studio + Azure AI를 결합해 실제 기업 업무를 자동화하는 에이전트를 직접 설계하고 배포한다.</p>
...
<h2 style="margin-top: 1.4rem; padding: 0.55rem 0.85rem; border-left: 6px solid #2563eb; background: #f8fafc;">📋 한눈에 보는 학습 리소스 요약</h2>

<div style="overflow-x: auto; margin: 1rem 0 1.4rem;">
  <table style="width: 100%; border-collapse: collapse; font-size: 0.95rem;">
    <tr style="background: #eff6ff;">
      <th style="padding: 0.6rem; border: 1px solid #bfdbfe; text-align: left;">난이도</th>
...
<div style="margin: 1rem 0 0; padding: 1.15rem 1.2rem; border-radius: 18px; background: linear-gradient(135deg, #111827 0%, #1f2937 100%); color: #f9fafb; line-height: 1.85;">
  <div style="font-weight: 800; margin-bottom: 0.5rem; font-size: 1.05rem;">🎯 마치며 — 당신의 속도로, 충분하다</div>
  AI 시대에 조급해할 필요 없다. 모두가 동시에 전문가가 될 수는 없고, 될 필요도 없다. 초급 강의 하나 완주하면 어느새 팀에서 제일 먼저 "이거 Copilot으로 해봤어요!"를 외치는 사람이 되어 있을 것이고, 중급·고급으로 올라가다 보면 어느 날 갑자기 당신이 팀의 'Copilot 선생님'이 되어 있을 것이다. 😄
  <div style="margin-top: 0.8rem; font-size: 0.92rem; color: #9ca3af;">Wave 3, E7, Agent 365 — 숫자와 이름은 계속 바뀌지만, 핵심은 하나다: M365 Copilot은 지금 이 순간도 당신의 업무 옆에서 조용히 기다리고 있다.</div>
</div>
