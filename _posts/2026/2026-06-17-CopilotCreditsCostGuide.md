...
Microsoft 365 관리 센터에서 **Copilot → Cost management**로 진입합니다.

> 참고: 기존 **Copilot > Cowork** 하위에 있던 비용 관리 화면은 최근 관리 센터에서 **청구(Billing) > 종량제(Pay-as-you-go)** 영역으로도 이동·통합되었습니다. 테넌트에 표시되는 경로로 진입하면 되며, 도달하는 비용 관리 대시보드는 동일합니다.
