...
![alt text](/mwkorea/assets/8_scheduler/image.png)
...
![alt text](/mwkorea/assets/8_scheduler/image-4.png)

이제 실행할 애플리케이션의 경로를 지정해야 해요.  
설정할 내용은 **Application Path**와 **Command line arguments** 두 가지입니다.  

![alt text](/mwkorea/assets/8_scheduler/image-5.png)
...
![alt text](/mwkorea/assets/8_scheduler/image-6.png) 
...
![alt text](/mwkorea/assets/8_scheduler/image-7.png)
...
![alt text](/mwkorea/assets/8_scheduler/image-8.png) 
![alt text](/mwkorea/assets/8_scheduler/image-9.png)
...
![alt text](/mwkorea/assets/8_scheduler/image-10.png)
![alt text](/mwkorea/assets/8_scheduler/image-11.png)
...
![alt text](/mwkorea/assets/8_scheduler/image-12.png)
...
![alt text](/mwkorea/assets/8_scheduler/image-13.png)
...
![alt text](/mwkorea/assets/8_scheduler/image-14.png)
...
![alt text](/mwkorea/assets/8_scheduler/image-15.png)

그러면 아래처럼 **Trigger를 설정할 수 있는 창**이 나와요.  

![alt text](/mwkorea/assets/8_scheduler/image-16.png)  
...
![alt text](/mwkorea/assets/8_scheduler/image-17.png) 

그러면 **어떤 프로그램을 실행할지 설정하는 창**이 나와요.  

![alt text](/mwkorea/assets/8_scheduler/image-18.png)
